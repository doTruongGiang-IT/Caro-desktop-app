...
public class ExitMainScreen extends javax.swing.JFrame{
    ...
    private void initComponents(String image, String title, String alert, String choice_1, String choice_2) {
        ...
        exit_btn.setIcon(new javax.swing.ImageIcon("./images/exit_20_20.png"));
        ...
        icon_main.setIcon(new javax.swing.ImageIcon(image)); // NOI18N
        ...
        exitForm_Label.setIcon(new javax.swing.ImageIcon("./images/exitGUI.png")); // NOI18N
    ...
    private void initComponents(String image, String title, String alert, String choice) {
        ...
        exit_btn.setIcon(new javax.swing.ImageIcon("./images/exit_20_20.png")); // NOI18N
        exit_btn.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                exit_btnMouseClicked(evt);
            }
